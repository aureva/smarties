...
ccccccccccccccccccccccccccccccccccccc
     ...
     +              d2_old,e2_old,betaa(i,j,k),uin,vin,win,
     +              i,j,k,1,me,t)
     ...
     +              d2(i,j,k),e1(i,j,k),e2(i,j,k))
               ...
               if(rtnewt.le.0.or.rtnewt.gt.(100.0))then
...
cc                  cs2(i,j,k)=0.001				  
                  ...
                  if(t.le.1.and.INITU.ne.1) then
                     betaa(i,j,k)=1.
                  else	         
                     betaa(i,j,k)=rtnewt
                  end if
                  
cc                  betaa(i,j,k)=1-0.65*exp(-0.7*(me*nzb+k-1.5)*dz/delta)				  
...
c                     e2(i,j,k)=0.
                  ...
                  elseif(QN.lt.(0.0).or.NN.lt.(1.d-20))then    
