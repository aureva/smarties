...
c     L33=ww_hat(ii,jj,k)-w_hat2(ii,jj,k)
     ...
     +      2.*(tfr*L(k))**2.*betaa1D(k)*S_hat(ii,jj,k)*S11_hat(ii,jj,k)
       M22=2.*L(k)**2.*SS22_hat(ii,jj,k)-
     +     2.*(tfr*L(k))**2.*betaa1D(k)*S_hat(ii,jj,k)*S22_hat(ii,jj,k)
       M33=2.*L(k)**2.*SS33_hat(ii,jj,k)-
     +     2.*(tfr*L(k))**2.*betaa1D(k)*S_hat(ii,jj,k)*S33_hat(ii,jj,k)
       M12=2.*L(k)**2.*SS12_hat(ii,jj,k)-
     +     2.*(tfr*L(k))**2.*betaa1D(k)*S_hat(ii,jj,k)*S12_hat(ii,jj,k)
       M13=2.*L(k)**2.*SS13_hat(ii,jj,k)-
     +     2.*(tfr*L(k))**2.*betaa1D(k)*S_hat(ii,jj,k)*S13_hat(ii,jj,k)
       M23=2.*L(k)**2.*SS23_hat(ii,jj,k)-
     +     2.*(tfr*L(k))**2.*betaa1D(k)*S_hat(ii,jj,k)*S23_hat(ii,jj,k)
